                        ...
                        <form>
                            <div>
                                ...
                                <div className="max-w-sm">
                                    <hr className="w-3/12 my-px bg-red-500" style={{ height: '2px' }} />
                                    <hr className="w-2/12 my-px bg-red-500" style={{ height: '1.8px' }} />
                                    <hr className="w-1/12 my-px bg-red-500" style={{ height: '1.5px' }} />
                                </div>
                            </div>
                            <div className="my-6 lg:my-12 space-y-2">
                                ...
                                <div>
                                    <TextField label='Subject' size="small" className="w-full" />
                                </div>
                                <div>
                                    <textarea className="border border-1 w-full" placeholder="Message" />
                                </div>
