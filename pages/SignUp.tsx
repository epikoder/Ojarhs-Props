	...
	return (
		<Layout>
			<div className='my-16 bg-gray-100 lg:w-8/12 w-11/12 mx-auto px-2 overflow-hidden md:w-10/12 lg:space-y-4 lg:py-8 lg:p-4 shadow-md shadow-gray-600 space-y-2 py-4'>
				...
				<form
					action=''
					className='py-2 px-1 md:px-2 lg:px-4 md:grid md:grid-cols-2 gap-4'
				>
					<div>
						...
						<FormPasswordInput
							props={{ title: "Password", hidden: togglePasswordState }}
						/>
						...
						<label htmlFor='' className='space-x-4 w-full text-gray-600'>
