		...
		<>
			<div className='flex flex-row'>                               
				<img
					...
					className='rounded-full md:rounded-xl h-32 w-32 md:w-48 md:h-48 object-cover'
				/>
				<div className='p-4 md:py-8'>
					...
					<div className='text-sm text-ellipsis overflow-hidden whitespace-nowrap w-36 md:w-60'>
						...
						<div className='flex justify-between text-sm font-semibold text-ellipsis overflow-hidden whitespace-nowrap w-36 md:w-60 lg:w-[40vh] my-2 '>
							{user.address}                                                     
						</div>                                                
				</div>
			</div>
